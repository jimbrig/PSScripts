...
.PROJECTURI https://github.com/jimbrig/PSScripts/tree/main/Get-InstalledApps/
...
### Version 1.0.1
    Added to new repository w/ more metadata.
...
<#
  .SYNOPISIS
  Lists Installed Software and Applications
  .DESCRIPTION 
